...
const storyParagraphsI18n: Partial<Record<Lang, string[]>> = {
  da: [
    ...
    "Det, der startede som en vision mellem to mænd, er vokset til en solid og succesfuld virksomhed, der gør en mærkbar forskel hver dag. I dag leverer vi vores løsninger til 70 danske kommuner samt en lang række private virksomheder – og til kunder i flere andre lande, især Tyskland og Sverige.",
  ],
  de: [
