...
const E = makeCatalog("push-buttons", "E", [
  ...
  { slug: "nfc-vs-wireless-buttons", title: "NFC vs wireless buttons.", lead: "When to choose tap-to-report NFC stickers, and when a dedicated wireless button is worth the extra cost.", tags: ["module:push-buttons", "sensor:touch", "type:comparison", "level:advanced"] },
...
const I = makeCatalog("sensors", "I", [
  ...
  { slug: "nb-iot-rf-budget", title: "NB-IoT RF budget.", lead: "Link budgets, penetration into basements and underground vaults, and carrier considerations.", tags: ["module:platform", "type:technical", "level:advanced"] },
...
const K = makeCatalog("integrations", "K", [
  ...
  { slug: "integration-os2iot", title: "Integration: OS2iot.", lead: "A turnkey IoT bridge for Danish municipalities using the OS2iot community platform.", tags: ["module:platform", "industry:municipalities", "type:integration", "level:advanced"] },
