...
export const caseHubI18n: Partial<Record<Lang, CaseHubOverlay>> = {
  ...
  de: {
    ...
    eyebrow: "Referenzen",
    lead: "Bleiben Sie Indoor climate und Space-Management mit Daten in RoomAlyzer voraus.",
  },
  sv: {
    title: "Kundcase.",
...
export const caseLeafI18n: Partial<Record<Lang, Record<string, CaseLeafOverlay>>> = {
  ...
  de: {
    ...
    "varde-municipality": { title: "Gemeinde Varde.", lead: "Verbessert das Wohlbefinden und sorgt durch die Zusammenlegung von Verwaltungsgebäuden für eine faire Verteilung." },
    ...
    "archdiocese-of-freiburg": { title: "Erzdiözese Freiburg.", lead: "Sensibilisiert Ehrenamtliche durch datenbasiertes Verständnis des Indoor climates." },
    "evangelische-kirche-in-hessen-und-nassau": { title: "Evangelische Kirche in Hessen und Nassau.", lead: "Schützt historische Kirchen durch präzise Indoor climate monitoring." },
    sweco: { title: "Sweco.", lead: "Sweco hilft Immobilieneigentümern, ein gutes Indoor climate in ihren Gebäuden sicherzustellen." },
    ...
    "boligselskabet-sjaelland": { title: "Boligselskabet Sjælland.", lead: "Boligselskabet Sjælland hatte Schwierigkeiten, die Veränderungen des Indoor climates vor und nach Renovierungen von Gebäuden und Wohnungen zu dokumentieren." },
    "vejen-kommune": { title: "Gemeinde Vejen.", lead: "Die Gemeinde Vejen hatte mit Beschwerden über das Indoor climate zu tun und konnte schwer Schlüsse ziehen: Was sind Fakten und was sind Gefühle?" },
    "rudersdal-museer": { title: "Rudersdal Museen.", lead: "Rudersdal Museen suchten eine Lösung, die ein optimales Indoor climate in Ausstellungs- und Lagerräumen sicherstellt." },
    "solroed-kommune": { title: "Gemeinde Solrød.", lead: "Die Gemeinde Solrød hatte ein älteres Indoor climate-Sensorsystem." },
    "gribskov-kommune": { title: "Gemeinde Gribskov.", lead: "Die Gemeinde ist Teil des Indoor climateprojekts von Realdania und nutzt die RoomAlyzer-Plattform, um zu entscheiden, wie die Bedingungen in Schulen und anderen Gebäuden verbessert werden." },
    ...
    "zealand-erhvervsakademi": { title: "Zealand Business Academy.", lead: "Zealand wollte die volle Kontrolle über das Indoor climate in allen Unterrichtsräumen." },
    "holbaek-kommune": { title: "Gemeinde Holbæk.", lead: "Wir haben uns für RoomAlyzer entschieden, weil wir den Fokus auf das Indoor climate legen und unseren Mitarbeitenden die besten Bedingungen bieten wollen." },
  },
  sv: {
