...
const en: IndoorClimateStrings = {
  ...
  fmItems: [
    "See the status of all rooms and sensors — quickly find where problems occur",
    "Get alerts when temperature, humidity, or CO₂ exceed the limits",
    "Compare locations and time periods — find patterns and outliers",
    "Maps and floor plans provide an overview of the entire property",
  ],
  complianceHeading: "For compliance officers & ESG managers",
  complianceItems: [
    "History and graphs you can use in meetings, dispute resolutions, and internal follow-ups",
    "Scheduled reports and PDFs sent automatically to the right recipients",
    "Export of raw data when you need to dive deeper or share with consultants",
    "Overview of deviations over time — not just a snapshot",
  ],
...
const da: IndoorClimateStrings = {
  ...
  fmItems: [
    "Se status på alle rum og sensorer — find hurtigt hvor der er problemer",
    "Få alarm når temperatur, fugt eller CO₂ går over grænserne",
    "Sammenlign lokationer og perioder — find mønstre og outliers",
    "Kort og plantegninger giver overblik over hele ejendommen",
  ],
  complianceHeading: "Til compliance-ansvarlige og ESG-managere",
  complianceItems: [
    "Historik og grafer I kan bruge i møder, klagesager og interne opfølgninger",
    "Planlagte rapporter og PDF'er sendt automatisk til de rigtige modtagere",
    "Eksport af rådata, når I skal dykke dybere eller dele med rådgivere",
    "Overblik over afvigelser over tid — ikke bare et øjebliksbillede",
  ],
...
const de: IndoorClimateStrings = {
  ...
  fmItems: [
    "Status aller Räume und Sensoren einsehen — schnell herausfinden, wo Probleme auftreten",
    "Alarme erhalten, wenn Temperatur, Luftfeuchtigkeit oder CO₂ die Grenzwerte überschreiten",
    "Standorte und Zeiträume vergleichen — Muster und Ausreißer finden",
    "Karten und Grundrisse bieten einen Überblick über die gesamte Immobilie",
  ],
  complianceHeading: "Für Compliance-Verantwortliche & ESG-Manager",
  complianceItems: [
    "Historie und Grafiken, die Sie in Meetings, bei Beschwerdefällen und internen Nachverfolgungen nutzen können",
    "Geplante Berichte und PDFs, die automatisch an die richtigen Empfänger gesendet werden",
    "Rohdatenexport, wenn Sie tiefer analysieren oder Daten mit Beratern teilen müssen",
    "Überblick über Abweichungen im zeitlichen Verlauf — nicht nur eine Momentaufnahme",
  ],
...
const sv: IndoorClimateStrings = {
  ...
  fmItems: [
    "Se status på alla rum och sensorer — hitta snabbt var problemen finns",
    "Få larm när temperatur, luftfuktighet eller CO₂ överstiger gränsvärdena",
    "Jämför platser och perioder — hitta mönster och outliers",
    "Kartor och planritningar ger en överblick över hela fastigheten",
  ],
  complianceHeading: "För compliance-ansvariga och ESG-chefer",
  complianceItems: [
    "Historik och grafer ni kan använda i möten, klagomålsärenden och interna uppföljningar",
    "Schemalagda rapporter och PDF:er skickas automatiskt till rätt mottagare",
    "Export av rådata när ni behöver dyka djupare eller dela med rådgivare",
    "Överblick över avvikelser över tid — inte bara en ögonblicksbild",
  ],
