 ...
 * into `{slug}-dimensions.webp`. Spec text comes from `sensorDimensions.ts`
...
export const sensorProductImages: Record<string, SensorProductImage> = {
  ...
  "range-extender-and-bracket": {
    src: `${BASE}/range-extender.webp`,
    extraSrc: [`${BASE}/bracket.webp`],
    inUseSrc: [
      `${BASE}/range-extender-and-bracket-in-use.webp`,
