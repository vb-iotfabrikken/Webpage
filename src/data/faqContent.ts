...
export const faqContent: Record<string, Qa[]> = {
  ...
  "indoor-climate": [
    ...
    { q: "What CO₂ threshold should we use?", a: "EN 16798 Category II defines 800–1200 ppm as acceptable, and most of our school customers set alarms at 1200 ppm. Where Danish BR18 applies, CO₂ must stay below 1000 ppm during occupied hours; check your local building rules for the equivalent limit in your country." },
  ...
  pricing: [
    ...
    { q: "Can we invoice as a public-sector customer?", a: "Yes. We serve Danish, Swedish, Norwegian and German public-sector customers directly and can invoice through standard e-invoicing channels (EHF, PEPPOL and OIOUBL in Denmark, or your local equivalent elsewhere)." },
