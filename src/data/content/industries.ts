...
export const industryPageContent: IndustryPageContent[] = [
  {
    ...
    challenges: [
      ...
      "HVAC running blind: systems heat and ventilate empty zones while underperforming when rooms are full, wasting energy without improving wellbeing.",
    ],
    solution: [
      "RoomAlyzer Space management delivers anonymised desk- and room-level occupancy in real time and over time, so you can right-size floors, see booking-versus-actual-use, and release ghost-booked meeting rooms (including via Google Calendar, Microsoft 365, or Pronestor). Context matters: the UK Workspace Survey shows office attendance fell from 83% of working time in 2016 to 46% in 2023, a 37-point drop in seven years.",
      "RoomAlyzer Indoor climate adds continuous CO2, temperature, humidity, and TVOC monitoring so afternoon fatigue and ventilation complaints are answered with facts, not impressions. Wireless sensors install in minutes without a Wi-Fi project, and the same platform shows space use and air quality side by side.",
    ],
    smarterTogether:
      "Combined, RoomAlyzer Space management and Indoor climate let you match ventilation and heating to the people actually present, cutting energy waste without sacrificing comfort on busy days.",
    closing:
    ...
    sensorRecommendations: [
      ...
      },
      {
        ...
        body: "Measures CO2, temperature, humidity, and TVOC to fight afternoon fatigue and maintain peak cognitive performance.",
  ...
  },
  {
    ...
    challenges: [
      ...
      "Uneven heating across huge volumes: nave, chancel, and sacristies behave differently, so handheld readings are unreliable.",
      "Outdoor weather drives indoor swings: massive masonry buildings react slowly, and indoor data without an outdoor reference is hard to interpret.",
      "Preservation versus the energy bill: heating a historic building to protect its contents is costly, and without data you cannot find the balance.",
    ],
    solution: [
      "RoomAlyzer Preservation monitors temperature and humidity continuously (±0.1 °C · ±1 % RH) and turns readings into clear documentation of the exact conditions your interiors are kept in. Wireless Mini+ and Full+ sensors are discreet enough for sacred spaces and precise enough for conservators, with alerts when thresholds are crossed.",
    ...
    smarterTogether:
      "RoomAlyzer Preservation gives conservators protecting the inventory and building teams running the estate the same dataset, a balance rarely found in a single tool.",
    closing:
    ...
    sensorRecommendations: [
      {
        name: "Mini+ / Full+",
        badge: "Vital",
        body: "Conservator-grade temperature and humidity logging (±0.1 °C · ±1 % RH) to protect building materials, historic woodwork, and organ mechanics.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
  ...
  },
  {
    ...
    challenges: [
      ...
      "Visitor-driven climate spikes: groups and events push humidity and temperature up fast, and without presence data you cannot connect cause and effect.",
    ...
    solution: [
      "RoomAlyzer Preservation delivers continuous wireless temperature and humidity logging in EN 15757 bands, in galleries, stores, and transport crates. Curators get drift alerts before conditions slip, and audit-ready PDF reports for insurance and loan agreements.",
    ...
    sensorRecommendations: [
      {
        ...
        body: "Conservator-grade wireless tracking of temperature and relative humidity (±0.1 °C · ±1 % RH) to prevent deterioration of delicate artwork and artefacts.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Motion Sensor",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate puts CO2, temperature, humidity, and TVOC sensors in every classroom and shared space, with alerts before levels pass guidelines and dashboards caretakers actually use. Varde Municipality rolled out 1,400 sensors across 36 schools in nine weeks; average CO2 above 1,200 ppm during teaching hours fell from 23% to 6% in ten months.",
      "RoomAlyzer Space management maps real occupancy in sports halls, auditoriums, and community rooms so heating and ventilation can step back when rooms are empty. One municipal dashboard brings every building together (schools, administration, and culture) without a separate system per site.",
    ],
    smarterTogether:
      "RoomAlyzer Indoor climate and Space management together let municipalities fine-tune ventilation to actual headcount and cut energy in buildings that stand empty outside school hours.",
    closing:
    ...
    sensorRecommendations: [
      {
        ...
        body: "Monitors CO2, temperature, humidity, and TVOC to ensure a low-CO2 environment, which is directly tied to student focus and health.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate puts live CO2, temperature, humidity, and TVOC data in every classroom with alerts before guidelines are breached, giving teachers a clear signal to ventilate and leadership evidence that conditions are managed.",
      "RoomAlyzer Space management maps real use in halls and specialist rooms so heating and ventilation can step back when buildings are empty. An Outdoor sensor gives a weather reference so natural ventilation decisions match conditions outside.",
    ],
    smarterTogether:
      "RoomAlyzer Indoor climate and Space management together show not only when air quality slips, but when energy is wasted heating rooms nobody is using.",
    closing:
    ...
    sensorRecommendations: [
      ...
      },
      {
        ...
        body: "Adds temperature, humidity, and TVOC to the CO2 picture in one discreet unit per classroom or specialist room.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Mini+ PIR / Motion Sensor",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate monitors CO2, temperature, humidity, and TVOC in patient-facing areas with continuous history, so air-quality discussions are grounded in data, not impressions.",
      "Dedicated Temperature and Humidity sensors cover pharmacies, labs, and cold storage with alerts before stock is at risk. RoomAlyzer Water detection sends SMS and email alerts from plant and service areas, with a timestamped incident log, before a leak reaches clinical zones.",
    ],
    smarterTogether:
      "RoomAlyzer Indoor climate and Water detection on one platform give estates teams a single view of comfort, compliance, and infrastructure risk across the hospital estate.",
    closing:
    ...
    sensorRecommendations: [
      {
        ...
        body: "Continuous CO2, temperature, humidity, and TVOC monitoring in patient-facing areas to document air quality and comfort.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Temperature Sensor",
      ...
      },
      {
        name: "Water Detector",
        badge: "Early warning",
        body: "SMS and email alerts in plant rooms, shafts, and service areas before a leak reaches clinical or electrical zones.",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate keeps temperature, humidity, CO2, and TVOC stable in common areas and resident rooms with alerts when conditions move outside agreed bands.",
      "RoomAlyzer Push buttons give one-tap service requests from washrooms and dining areas, routed by email or SMS before issues become complaints. Temperature loggers add precision in kitchens and laundry rooms, while RoomAlyzer Water detection alerts staff in wet rooms and plant areas early.",
    ],
    smarterTogether:
      "RoomAlyzer Indoor climate and Push buttons on one platform help staff prioritise both comfort and response time without adding complexity to daily rounds.",
    closing:
    ...
    sensorRecommendations: [
      {
        ...
        body: "Monitors CO2, temperature, humidity, and TVOC in common areas and resident rooms to keep conditions stable day and night.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Temperature Sensor",
      ...
      },
      {
        ...
        body: "One-tap service calls from washrooms, dining areas, or resident rooms, with no phones and no hunting for the right extension.",
        sensorSlugs: ["touch"],
      },
      {
        name: "Water Detector",
        badge: "Protect the building",
        body: "SMS and email alerts in bathrooms, kitchens, and plant areas before moisture spreads into resident spaces.",
        sensorSlugs: ["water-detector"],
      },
    ],
  },
  {
    ...
    solution: [
      ...
      "RoomAlyzer Indoor climate tracks shop-floor CO2, temperature, humidity, and TVOC so comfort and energy can be balanced across long trading hours. Motion sensors map footfall patterns for utilisation insight; RoomAlyzer Lockers and doors confirms doors and bays are shut when the store closes, without nightly walk-throughs.",
    ],
    smarterTogether:
    ...
    sensorRecommendations: [
      ...
      },
      {
        ...
        body: "Tracks CO2, temperature, humidity, and TVOC on the sales floor to balance comfort with energy use across long opening hours.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Motion Sensor",
  ...
  },
  {
    ...
    solution: [
      ...
      "RoomAlyzer Indoor climate monitors lobbies, restaurants, and conference rooms where air quality drives guest perception. RoomAlyzer Usage and cleaning aligns housekeeping with actual room use; RoomAlyzer Push buttons give instant service feedback in washrooms and reception before issues reach review sites.",
    ],
    smarterTogether:
      "Room-level occupancy, indoor climate, and demand-based cleaning let hotels trim energy in vacant rooms while prioritising ventilation and housekeeping where guests are gathered.",
    closing:
    ...
    sensorRecommendations: [
      ...
      },
      {
        ...
        body: "Monitors CO2, temperature, humidity, and TVOC in lobbies, restaurants, and conference rooms where comfort drives reviews.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Motion Sensor",
  ...
  },
  {
    ...
    solution: [
      ...
      "Humidity sensors track RH in storage zones where materials are moisture-sensitive. RoomAlyzer Water detection covers linear risk with water rope along pipes and bay floors, and point sensors under sinks, trays, and plant equipment, with SMS and email alerts and a timestamped incident log for insurance.",
    ],
    smarterTogether:
      "Temperature, humidity, and RoomAlyzer Water detection on one platform give operations and QA teams a single dashboard for stock protection and incident response.",
    closing:
    ...
    sensorRecommendations: [
      ...
      },
      {
        ...
        body: "SMS and email alerts under sinks, condensate trays, and plant equipment before water spreads across the floor.",
        sensorSlugs: ["water-detector"],
      },
    ],
  },
  {
    ...
    solution: [
      "RoomAlyzer Preservation delivers continuous RH logging for stacks, manuscript stores, and rare-book rooms with alerts before conditions leave preservation bands.",
      "RoomAlyzer Indoor climate monitors reading rooms discreetly. Temperature loggers cover cold stores; an Outdoor sensor separates indoor trends from weather so HVAC responds to real need.",
    ],
    smarterTogether:
    ...
    sensorRecommendations: [
      {
        ...
        body: "Conservator-grade relative-humidity logging, the first line of defence for bindings, manuscripts, and historic stacks.",
        sensorSlugs: ["humidity"],
      },
      {
        name: "Mini+ / Full+",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Preservation tracks RH in halls, staircases, and panelled rooms with alerts before seasonal swings cause cracks, warping, or gilding loss.",
    ...
    smarterTogether:
      "Visitor presence and preservation climate data together explain sudden humidity rises, so teams can ventilate or adjust heating before interiors suffer.",
    closing:
    ...
    sensorRecommendations: [
      {
        ...
        body: "Conservator-grade RH logging in halls, staircases, and panelled rooms where seasonal swings cause cracks, warping, and gilding loss.",
        sensorSlugs: ["humidity"],
      },
      {
        name: "Mini+ / Full+",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate delivers objective CO2, temperature, humidity, and TVOC data in tenant spaces, resolving comfort complaints with evidence instead of debate.",
      "RoomAlyzer Water detection sends SMS and email alerts from sensors under sinks, boilers, and risers, with water rope for basements and plant areas and a timestamped incident log for insurance. Temperature loggers monitor technical rooms across the portfolio from one dashboard.",
    ],
    smarterTogether:
      "RoomAlyzer Indoor climate and Water detection together reduce both tenant churn and emergency call-outs, the two cost drivers property teams feel most acutely.",
    closing:
    ...
    sensorRecommendations: [
      {
        name: "Mini+ / Full+",
        badge: "Tenant spaces",
        body: "Objective CO2, temperature, humidity, and TVOC data to resolve 'too hot' or 'too stuffy' complaints with evidence.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Water Detector",
        badge: "Leak prevention",
        body: "SMS and email alerts under sinks, boilers, and risers before water reaches neighbouring units.",
        sensorSlugs: ["water-detector"],
      },
      {
        name: "Water Rope",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate is the default rollout: Mini+ and Full+ sensors cover CO2, temperature, humidity, and TVOC in one unit, with dashboards FM teams can brand for each contract.",
      "RoomAlyzer Space management backs utilisation recommendations with anonymised desk and room data. RoomAlyzer Usage and cleaning directs effort to spaces actually used. RoomAlyzer Water detection adds SMS and email leak alerts at low marginal cost. Cloud connector brings data to the platform over cellular, with no client Wi-Fi per building.",
    ],
    smarterTogether:
      "RoomAlyzer Indoor climate, Space management, Usage and cleaning, and Water detection on one platform let FM providers cross-sell services with a single install visit and one ongoing data relationship.",
    closing:
    ...
    sensorRecommendations: [
      {
        ...
        body: "The default rollout sensor for offices, schools, and public buildings, covering CO2, temperature, humidity, and TVOC in one unit.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
      ...
      },
      {
        ...
        body: "A low-cost upsell with SMS and email alerts that catches leaks before they become emergency call-outs and insurance events.",
        sensorSlugs: ["water-detector"],
      },
      {
        name: "Cloud Connector",
        badge: "Site connectivity",
        body: "Brings sensor data to the platform over cellular uplink, with no client Wi-Fi and no IT project per building.",
  ...
  },
  {
    ...
    solution: [
      "RoomAlyzer Indoor climate provides multi-parameter logging (CO2, temperature, humidity, TVOC) for post-occupancy evaluation, ventilation verification, and indoor-climate studies, with exportable history for reports.",
      "An Outdoor sensor gives the baseline serious audits expect. Dedicated Temperature and Humidity loggers cover problem zones; RoomAlyzer Space management validates occupancy assumptions behind ventilation and heating schedules.",
    ],
    smarterTogether:
    ...
    sensorRecommendations: [
      {
        ...
        body: "Multi-parameter logging (CO2, temperature, humidity, TVOC) for post-occupancy evaluation, ventilation verification, and indoor-climate studies.",
        sensorSlugs: ["mini-plus", "full-plus"],
      },
      {
        name: "Outdoor Sensor",
