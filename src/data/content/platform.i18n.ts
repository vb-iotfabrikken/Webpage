  ...
  "how-it-works": {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "I får både en mobilapp og en udvidet webapp, så I kan samle alle jeres data i ét dashboard og altid have et klart overblik. Det gør ingen forskel, hvordan I sammensætter jeres sensorpakke, eller hvor mange rum, bygninger og lokationer I bruger RoomAlyzer på — det hele samles i ét enkelt, overskueligt overblik.",
        ],
      },
      {
  ...
  security: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Jede Zugriffsänderung wird protokolliert. Wenn ein Nutzer hinzugefügt oder entfernt wird, eine Rolle geändert oder ein Konto erstellt oder gelöscht wird, entsteht ein unveränderlicher Eintrag — wer, wen, was, wann. Administratoren können die vollständige Zugriffshistorie jedes Nutzers einsehen — interne Compliance wird einfach, und die Frage ist beantwortet, die irgendwann jeder stellt: wer hatte wann Zugriff auf was?",
        ],
      },
      {
